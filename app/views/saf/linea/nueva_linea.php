...
<!-- content starts -->
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo HTML_PATH_ADMIN;?>nueva_linea">Nueva Línea</a>
					</li>
				</ul>
			</div>
            <div id="mensaje"> </div>
            ...
            <div class="box-header well" data-original-title>
                <h2><i class="icon-inbox"></i> Ingresar Nueva Línea</h2>
            </div>
            <div class="box-content">
            <?php echo $_SESSION['respuesta'] ;?>
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="guardar_nueva_linea">
				<fieldset>
                    <div class="control-group">
                      <label class="control-label" for="nombre_marca">Nombre de la línea: * </label>
                      <div class="controls">
                        <input type="text" id="nombre_linea" name="nombre_linea" class="span6">
                      </div>
                    </div>    
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="ckeditor" id="detalle_linea" name="detalle_linea" rows="3"></textarea>
                      </div>
                    </div>
                    <div class="control-group">
                       ...
                       <div class="form-actions">
                        <input type="submit" class="btn btn-primary" value="Guardar línea" />
