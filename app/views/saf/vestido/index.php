...
<div id="page-heading"><h1>Añadir Vestido</h1></div>
...
<tr>
	...
	<td>
	  <?php echo $respuesta;?>
		<!-- start id-form -->
        <form enctype="multipart/form-data" method="post" action="<?php echo HTML_PATH; ?>saf/vestido/nuevo" >
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="nombre" id="nombre" /></td>
			<td></td>
		</tr>
	<tr>
    <tr>
			<th valign="top">Colores:</th>
			<td><input type="text" class="inp-form" name="colores" id="colores" /></td>
			<td></td>
		</tr>
	<tr>
    <tr>
			<th valign="top">Colección:</th>
			<td><input type="text" class="inp-form" name="coleccion" id="coleccion" /></td>
			<td></td>
		</tr>
	<tr>
   <th>Imágen:</th>
	<td><input type="file" class="inp-form" name="imagen" id="imagen" /></td>
	 <td></td>
     <td>
	</td>
    ...
    <th>Imágen Grande:</th>
	<td><input type="file" class="inp-form" name="imagen_grande" id="imagen_grande" /></td>
	 <td></td>
     <td>
	</td>
    ...
    <tr>
			...
			<td><input type="text" class="inp-form" name="precio" id="precio" /></td>
			<td></td>
		</tr>
	<tr>
		<th valign="top">Descripción:</th>
		<td><textarea id="descripcion" name="descripcion" rows="10" class="form-textarea"></textarea></td>
		<td></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
