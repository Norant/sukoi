...
<div id="page-heading"><h1>Cambiar password</h1></div>
...
<tr>
	...
	<td>
	  <?php echo $_SESSION['respuesta']; ?>
		<!-- start id-form -->
        <form  method="post" action="<?php echo HTML_PATH; ?>saf/cambiarpassword" >
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th valign="top">Ingrese Password:</th>
			<td><input type="password" class="inp-form" name="pass1" id="pass1" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">re-ingrese Password:</th>
			<td><input type="password" class="inp-form" name="pass2" id="pass2" /></td>
			<td></td>
		</tr>
	<tr>
		<th>&nbsp;</th>
