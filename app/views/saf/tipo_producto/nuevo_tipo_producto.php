...
<!-- content starts -->
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo HTML_PATH_ADMIN;?>nuevo_tipo_producto">Nuevo Típo de Producto</a>
					</li>
				</ul>
			</div>
            <div id="mensaje"> </div>
            ...
            <div class="box-header well" data-original-title>
                <h2><i class="icon-inbox"></i> Ingresar Nuevo Típo de Producto</h2>
            </div>
            <div class="box-content">
            <?php echo $_SESSION['respuesta'] ;?>
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="guardar_nuevo_tipo">
				<fieldset>
                    <div class="control-group">
                      <label class="control-label" for="nombre_tipo_producto">Nombre del Típo de Producto: * </label>
                      <div class="controls">
                        <input type="text" id="nombre_tipo_producto" name="nombre_tipo_producto" class="span6">
                      </div>
                    </div>    
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea class="ckeditor" id="descripcion_tipo_producto" name="descripcion_tipo_producto" rows="3"></textarea>
                      </div>
                    </div>
                    <div class="control-group">
                       ...
                       <div class="form-actions">
                        <input type="submit" class="btn btn-primary" value="Guardar Típo de Producto" />
