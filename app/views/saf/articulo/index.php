...
<tr>
	...
	<td>
	  <?php echo $respuesta;?>
		<!-- start id-form -->
        <form enctype="multipart/form-data" method="post" action="<?php echo HTML_PATH; ?>saf/articulo/nuevo" >
		...
		<select  class="styledselect_pages" name="id_tipo_articulo" id="id_tipo_articulo">
			<option value="">---</option>
            <?php
			foreach ($tipo_articulo as $tipo_art)
			{
			echo "<option value=\"".$tipo_art['id_tipo_articulo']."\">".$tipo_art['nombre_tipo_articulo']."</option>";
			}
			?>
		</select>
		</td>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="nombre_articulo" id="nombre_articulo" /></td>
			<td></td>
		</tr>
	<tr>
		<th valign="top">Descripción:</th>
		<td><textarea id="descripcion_articulo" name="descripcion_articulo" rows="10" class="form-textarea"></textarea></td>
		<td></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
