...
<tr>
	...
	<td>
	  <?php echo $respuesta;?>
		<!-- start id-form -->
        <form enctype="multipart/form-data" method="post" action="<?php echo HTML_PATH; ?>saf/articulo/editar/<?php echo $id_articulo; ?>" >
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
        <tr>
		<th valign="top">Categoría:</th>
		<td>	
		<select  class="styledselect_pages" name="id_tipo_articulo" id="id_tipo_articulo">
			<option value="">---</option>
			 <?php
			foreach ($categorias as $cat)
			{
				if ($articulo->id_tipo_articulo == $cat['id_tipo_articulo']){
					echo utf8_encode("<option value=\"".$cat['id_tipo_articulo']."\" selected=\"selected\">".$cat['nombre_tipo_articulo']."</option>");
					}else{
					echo utf8_encode("<option value=\"".$cat['id_tipo_articulo']."\">".$cat['nombre_tipo_articulo']."</option>");
					}
			}
			?>
		</select>
		...
		<tr>
			...
			<td><input type="text" class="inp-form" name="nombre_articulo" id="nombre_articulo" value="<?php echo $articulo->nombre_articulo;?>" /></td>
			<td></td>
		</tr>
	<tr>
		<th valign="top">Descripción:</th>
		<td><textarea id="descripcion_articulo" name="descripcion_articulo" rows="10" class="form-textarea"> <?php echo utf8_encode($articulo->descripcion_articulo);?></textarea></td>
		<td></td>
	</tr>
	<tr>
		<th>&nbsp;</th>
...
var editor = CKEDITOR.replace( 'descripcion_articulo',
					{
skin : 'kama',
